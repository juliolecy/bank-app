...
const Hero = () => (
    ...
    <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col x1:px-0 sm:px-16 px-6`}>
        <div className='flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounder-[10px] mb-2'>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores magni pariatur doloremque dolor odit! Officia quasi, iusto omnis commodi accusamus dolore. Unde natus sequi harum. </p>
